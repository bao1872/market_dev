...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "reused_from_run_id", _uuid(),
            sa.ForeignKey("board_facts_runs.id", name="fk_board_facts_runs_reused_from"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column("readiness", sa.Text(), nullable=True),
        sa.Column(
            "reuse_of_run_id", _uuid(),
            sa.ForeignKey("chip_consensus_runs.id", name="fk_chip_consensus_runs_reuse_of"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column("source_core_run_id", _uuid(), nullable=False),
        sa.Column(
            "source_chip_run_id", _uuid(),
            sa.ForeignKey("chip_consensus_runs.id", name="fk_auction_anchor_runs_source_chip"),
            nullable=True,
        ),
        ...
        sa.Column("diagnostics_json", postgresql.JSONB(), nullable=True),
        sa.Column(
            "superseded_by_run_id", _uuid(),
            sa.ForeignKey("auction_anchor_runs.id", name="fk_auction_anchor_runs_superseded_by"),
            nullable=True,
        ),
        sa.Column("started_at", sa.DateTime(timezone=True), nullable=True),
        sa.Column("heartbeat_at", sa.DateTime(timezone=True), nullable=True),
