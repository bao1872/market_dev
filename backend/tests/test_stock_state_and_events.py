...
# [CURRENT-CORE-OWNER-REGRESSION-01-R1] 旧 test_p03_find_latest_succeeded_run_* /
# test_p03_find_run_by_trade_date_* 已移除：被测试的函数 _find_latest_succeeded_run /
# _find_run_by_trade_date 已删除（它们以 legacy stock_core FactorPublication 为 CURRENT
# authority，与唯一 owner resolve_current_core_run 冲突）。CURRENT owner 的确定性排序与
# PIT 语义由 test_stock_context_current_owner.py（consumer 收敛）+ PG resolver 契约测试覆盖。
