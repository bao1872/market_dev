...
> 自动生成 by tools/update_docs.py | 生成时间: 2026-06-26 15:16:19
...
| dsa_backfill_instrument_progress | DSA 历史回补单只股票进度。 | (id) | backfill_job_id → dsa_backfill_jobs.id; instrument_id → instruments.id |
