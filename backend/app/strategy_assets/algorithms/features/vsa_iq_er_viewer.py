...
def build_figure(df: pd.DataFrame, out_html: str, title: str) -> None:
    ...
    fig.add_trace(
        go.Scatter(
            ...
            mode="lines+markers",
            line={"color": "#ff9ef9", "width": 2},
            marker={"size": 5, "color": "#ff9ef9"},
            name="Effort",
        ),
        row=2,
        col=1,
    ...
    fig.add_trace(
        go.Scatter(
            ...
            mode="lines+markers",
            line={"color": "#e9e2ff", "width": 2},
            marker={"size": 5, "color": "#e9e2ff"},
            name="Result",
        ),
        row=2,
        col=1,
    ...
    fig.add_trace(
        go.Scatter(
            ...
            y=df["effort_ma"],
            mode="lines",
            line={"color": "#d56fe8", "width": 1.6, "dash": "dot"},
            name="Effort MA",
        ),
        row=2,
        col=1,
    ...
    fig.add_trace(
        go.Scatter(
            ...
            y=df["result_ma"],
            mode="lines",
            line={"color": "#bfc7ff", "width": 1.6, "dash": "dot"},
            name="Result MA",
        ),
        row=2,
        col=1,
