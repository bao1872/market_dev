...
Registered Events:
    ...
    - evt_dsa_dir_flip_down: DSA方向翻转为下降（TRIGGER/VETO）
    - evt_cross_above_dsa_vwap: 价格上穿DSA VWAP（CONFIRM）
    - evt_cross_below_dsa_vwap: 价格下穿DSA VWAP（CONFIRM）
    - evt_vreversal: BBMACD V型反转（TRIGGER，dsa_experiment 核心选股事件）
"""
