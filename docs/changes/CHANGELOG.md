...
| CHANGE-20260703-016 | 2026-07-03 | 修复 worker_heartbeats 僵尸 running 记录清理机制 | committed | `fix/worker-heartbeat-stale-cleanup` | `40dd2287f0962910d2e272c468b3e5054abddaaf` | `80e3b74` | `backend/app/worker.py`、`backend/tests/test_worker_heartbeat_stale_cleanup.py`、`docs/current/11-jobs-integrations.md`、`docs/current/18-code-doc-alignment.md` |
