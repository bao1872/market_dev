...
`MarketDataAggregationService` (MDAS) 是行情读取唯一出口（详见 `docs/analysis/market-data-ssot-adjustment-v2.md`）。`/bars` API 与所有业务调用方（indicator/SMC、strategy_batch、feature_snapshot、chart_bars、structural、capture、monitor）均经 MDAS。
