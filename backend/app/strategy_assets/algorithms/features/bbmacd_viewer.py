...
def build_figure(df: pd.DataFrame, out_html: str, title: str) -> None:
    ...
    if sell_idx:
        ...
        fig.add_trace(
            go.Scatter(
                ...
                marker={"symbol": "triangle-down", "size": 10, "color": "#ff4d5a"},
                name="Venta",
            ),
            row=1,
            col=1,
    ...
    fig.add_trace(
        go.Scatter(
            ...
            y=df["banda_supe"],
            mode="lines",
            line={"color": "rgba(0,191,255,0.9)", "width": 1},
            name="上轨",
        ),
        row=2,
        col=1,
    ...
    for s, e, st in runs:
        ...
        fig.add_trace(
            go.Scatter(
                ...
                y=ys,
                mode="lines",
                line={"color": color_map[st], "width": 2},
                fill=fill,
                fillcolor=fillcolor,
                name=name_map[st],
    ...
    def add_signal_markers(mask_col: str, text_label: str, color: str, arrow_symbol: str, y_series: pd.Series, text_position: str) -> None:
        ...
        fig.add_trace(
            go.Scatter(
                ...
                marker={"symbol": arrow_symbol, "size": 11, "color": color, "line": {"width": 0.5, "color": color}},
                name=text_label,
            ),
            row=2,
            col=1,
