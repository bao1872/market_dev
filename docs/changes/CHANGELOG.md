...
| CHANGE-20260703-015 | 2026-07-03 | outbox target_channel_id 跳过 eligible_user_service（ddca659 hotfix 治理闭环） | committed | `chore/governance-baseline-repair-v2` | `ddca659b8c9d64b6a414da0b4bbd6f80f704aef1` | 待 push 后填写 | `backend/tests/test_outbox_target_channel_id.py`、`docs/current/18-code-doc-alignment.md`、`tools/check_docs_consistency.py`、`tools/tests/test_check_docs_consistency.py`、`docs/current/*.md`、`docs/README.md` |
