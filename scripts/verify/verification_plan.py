...
TIMEOUTS = {
    "standard": {"migration": 300, "tests": 900},
    "extended": {"migration": 600, "tests": 1800},
}
...
def load_plan(path: str | Path) -> VerificationPlan:
    ...
    for key in ("name", "migration_profile", "test_profile", "timeout_profile"):
    ...
    return VerificationPlan(
        ...
        test_profile=data["test_profile"], timeout_profile=data["timeout_profile"],
    )
