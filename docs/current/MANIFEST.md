...
> 实现核对基线：`40dd2287f0962910d2e272c468b3e5054abddaaf`  
> v2 文档包生成基线：`40dd2287f0962910d2e272c468b3e5054abddaaf`  
...
- 新发现：`worker_heartbeats` 存在 stale/running 僵尸记录，任务状态可信度需修复。
