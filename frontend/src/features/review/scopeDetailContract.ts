...
/** Current State / Freshness 现由 ScopeCurrentObservationWorkspace 的 extractObservationContext 拥有。
 *  原混合 parseCurrentSnapshot（R1 projection layer）已移除：ScopeDetailWorkspace 不再以其为 Current owner，
 *  ScopeCurrentSnapshotPanel 已删除。保留文件顶部的 Stage/Structure/Attribution/Groups 解析 owner。
 */
