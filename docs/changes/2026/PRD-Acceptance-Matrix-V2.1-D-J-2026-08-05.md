...
**基线**: `351b38d39c7a9b80c33b7c8bb99ff2e21d45d690`（CHANGE-20260806-005 V2.1 对齐 Phase 6 本地门禁核对时点 = Phase 6 提交后 current HEAD/origin/dev；Phase 7 远程验证通过后冻结 final SHA 时再同步）
