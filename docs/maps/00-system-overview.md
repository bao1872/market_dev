...
核验状态：高风险偏差索引已基于 Phase 5A 核验更新（P0 Redis 隔离、P1 AC-04 已关闭）；maps/40/30/80 已基于 CHANGE-20260729-009 更新（行情列表单一数据源+自选按钮+筹码原因+History版本一致性+Umami 访客分析）
最后核验日期：2026-07-31
核验分支：dev
核验提交：060343ddd874b51f26a1dd0529e510bbeb9620c8（is_stale PER-INSTRUMENT 修复 + mypy baseline 同步 + 监控截图统一视图）
核验范围：高风险偏差索引（§6）基于 Phase 5A 核验；maps/40 §4.7 / maps/30 §11.6-11.7 / maps/80 §7.1 基于 CHANGE-20260729-009 核验；其余组件关系待基于最新 dev 完整核验
...
| PS-01 | 待核验 | 未核验 | 未核验 |
| PS-02 | 待核验 | 未核验 | 未核验 |
| PS-03 | 门户和用户文案待核验 | 未核验 | 未核验 |
| PS-05 | 各领域 Map | 部分实现 | 需逐项核验 |
| PS-06 | 行情、个股和盘后输出待核验 | 未核验 | 未核验 |
| PS-07 | 仓库功能范围待核验 | 未核验 | 未核验 |
