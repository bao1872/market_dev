...
// [Marketing] 旧 /marketing-preview 入口已退役：正式营销门户为根 /（Marketing Site）。
// 兼容跳转见下方 LegacyMarketingPreviewRedirect。
...
// [Marketing] 旧 /marketing-preview 兼容跳转：触发浏览器真正请求服务器根路径 /，
// 而非停留在 SPA 内 / route。不引入第二份门户组件。
function LegacyMarketingPreviewRedirect() {
  useEffect(() => {
...
export const routeConfig: RouteObject[] = [
  ...
  // [Marketing] 旧 /marketing-preview 入口已退役，仅保留兼容跳转（浏览器重定向到 /）。
  {
    path: '/marketing-preview',
    element: <LegacyMarketingPreviewRedirect />,
  },
  {
    path: '/marketing-preview/*',
    element: <LegacyMarketingPreviewRedirect />,
