...
| PRD 条款 | 权威实现 | 状态 | 验证证据 |
|---|---|---|---|
| SW-01 | 时区配置待核验 | 未核验 | 未核验 |
| SW-02 | 时间字段待核验 | 未核验 | 未核验 |
| SW-10 | symbol/trade_date/run_id 等待核验 | 部分实现 | 未核验 |
| SW-11 | 主键和关联待核验 | 未核验 | 未核验 |
| SW-20 | 状态 Schema 待核验 | 未核验 | 未核验 |
| SW-21 | 错误路径待核验 | 未核验 | 未核验 |
| SW-30 | 来源字段待核验 | 未核验 | 未核验 |
| SW-31 | run/版本字段待核验 | 部分实现 | 未核验 |
| SW-40 | 正式结果读取入口待核验 | 部分实现 | 未核验 |
| SW-41 | 调试与正式隔离待核验 | 未核验 | 未核验 |
| SW-50 | 结构化失败状态待核验 | 未核验 | 未核验 |
| SW-51 | CI/报告行为待核验 | 未核验 | 未核验 |
